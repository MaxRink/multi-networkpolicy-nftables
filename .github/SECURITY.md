...
The Multi-NetworkPolicy nftables project is committed to security by design:

- **Network Policy Enforcement** - Secure enforcement of multi-network policies via nftables
- **Least Privilege** - Only required network rules are applied
