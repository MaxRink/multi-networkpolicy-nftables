...
@test "test-simple-v4-ingress-list check client-a -> server" {
	...
	run retry_until_success 15 kubectl -n test-simple-v4-ingress-list exec pod-client-a -- sh -c "echo x | nc -w 1 ${server_net1} 5555"
	[ "$status" -eq  "0" ]
}
...
@test "test-simple-v4-ingress-list check client-c -> server" {
	...
	run retry_until_success 15 kubectl -n test-simple-v4-ingress-list exec pod-client-c -- sh -c "echo x | nc -w 1 ${server_net1} 5555"
	[ "$status" -eq  "0" ]
}
...
@test "test-simple-v4-ingress-list check server -> client-a" {
	...
	run retry_until_success 15 kubectl -n test-simple-v4-ingress-list exec pod-server -- sh -c "echo x | nc -w 1 ${client_a_net1} 5555"
	[ "$status" -eq  "0" ]
}
...
@test "test-simple-v4-ingress-list check server -> client-b" {
	...
	run retry_until_success 15 kubectl -n test-simple-v4-ingress-list exec pod-server -- sh -c "echo x | nc -w 1 ${client_b_net1} 5555"
	[ "$status" -eq  "0" ]
}
