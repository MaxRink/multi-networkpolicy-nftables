...
@test "disable multi-networkpolicy and check nftables rules" {
	...
	wait_for_nft_rule_absent "test-simple-v4-ingress-multi" "pod-server" "test-multinetwork-policy-simple-1"
	wait_for_nft_rule_absent "test-simple-v4-ingress-multi" "pod-server" "test-multinetwork-policy-simple-2"
