...
// Apply is unsupported on non-Linux platforms (the tc flower backend needs
// Linux netlink). The stub keeps the package building for cross-platform
// tooling and tests.
func Apply(_ context.Context, _ controllers.PolicyDeps, _ controllers.CommonRuleConfig,
